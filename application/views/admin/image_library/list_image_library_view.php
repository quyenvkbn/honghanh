                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <div class="mask_sm">
                                                <img src="<?php echo base_url('assets/upload/'.$controller .'/'.$value['slug'].'/'.$value['avatar']) ?>" alt="anh-cua-<?php echo $value['slug'] ?>" width=150px>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" onclick="remove('image_library', <?php echo $value['id'] ?>)" class="dataActionDelete" title="Xóa bài viết"><i class="fa fa-remove" aria-hidden="true"></i> </a>
                                        </td>
