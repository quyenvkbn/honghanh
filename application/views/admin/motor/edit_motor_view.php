...
$array2 = array("a" => "greens", "yellow", "red");
                ...
                <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade in active" >
                                            ...
                                            <div class=" col-xs-12">
                                                <?php
                                                    ...
                                                    echo form_textarea('description', $product['description'], 'class="form-control" id="description"');
                                                ?>
                                            </div>
                                            <div class=" col-xs-12">
                                                <?php
                                        ...
                                        <div role="tabpanel" class="tab-pane fade in active" id="specifications">
                                            <div class=" col-xs-12">
                                                <?php
                                                    ...
                                                    echo form_input('frontbrake', $product['frontbrake'], 'class="form-control" id="frontbrake"');

                                                    echo form_label('Phanh sau', 'brakeafter');
                                                    echo form_error('brakeafter');
                                                    echo form_input('brakeafter', $product['brakeafter'], 'class="form-control" id="brakeafter"');
                                                    ...
                                                    echo form_input('inclination', $product['inclination'], 'class="form-control" id="inclination"');

                                                    echo form_label('Chiều dài vết quét', 'scanlength');
                                                    echo form_error('scanlength');
                                                    echo form_input('scanlength', $product['scanlength'], 'class="form-control" id="scanlength"');
                                                            ...
                                                            <div class="col-xs-12" style="padding: 0px;">
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <?php if (!empty($value['image'])): ?>
                                                                        <div class="row" style="margin-bottom: 5px;">
                                                                            <div class="col-xs-4">
                                                                                <img src="<?php echo base_url('assets/upload/product/'.$product['slug'].'/' .$value['image']) ?>" alt="anh-cua-<?php echo $product['slug'] ?>"  style="width: 100%;" value="<?php echo $value['image']; ?>">
                                                                            </div>
                                                                        </div>
                                                                    <?php else: ?>
                                                                        Chưa có hình ảnh
                                                                            ...
                                                                            <div class="box box-default" style="border-top:none;">
                                                                                <div class="box-body" style="padding:0px;">
                                                                                    <div class="col-xs-12" style="padding:0px;">
                                                                                        ...
                                                                                        <input type="text" value="<?php echo $value['title'] ?>" placeholder="" class="form-control title">
                                                                                        <span class="help-block hidden">Bạn cần nhập trường này</span>
                                                                                    </div>
                                                                                    <div class="col-xs-12" style="padding:0px;">
                                                                                        <label class="control-label" for="">Nội dung</label>
                                                                                        <textarea value="<?php echo $value['content'] ?>"  placeholder="" class="form-control content"><?php echo $value['content'] ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="color-products">        
                        <div class="box box-default">
                            <div class="box-body">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="version">
                                        <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                            <label class="col-md-12" for="">
                                                    Nhập số màu sắc của sản phẩm
                                            </label>
                                            <div class="col-md-12" style="margin-top:5px;">
                                                <input type="text" name="numbercolor" class="form-control numbercolor" value="<?php echo count($product['version']);?>" onkeypress=" return isNumberKey(event)" readonly="" />
                                            </div>
                                        </div>
                                                ...
                                                <?php foreach ($product['version'] as $k => $val): ?>
                                                    <div class="col-xs-12" style="margin-bottom:4px;">
                                                        <div class="btn btn-primary col-ms-12 color_product" style="padding:0px; padding-top:5px; width:100%;text-align:left">
                                                            <span data-toggle="collapse" data-target="#colorversion<?php echo $k+1;?>" class="col-xs-10 check-collapse" style="height:35px;padding-top:2px">
                                                        ...
                                                        <div id="colorversion<?php echo $k+1;?>" class="collapse in form-group">
                                                            <div class="col-xs-12" style="padding:0px;">
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <?php if (!empty($val['image'])): ?>
                                                                        <div class="row" style="margin-bottom: 5px;">
                                                                            <div class="col-xs-4">
                                                                                <img src="<?php echo base_url('assets/upload/product/'.$product['slug'].'/' .$val['image']) ?>" alt="anh-cua-<?php echo $product['slug'] ?>"  style="width: 100%;" value="<?php echo $val['image']; ?>">
                                                                            </div>
                                                                        </div>
                                                                    <?php else: ?>
                                                                ...
                                                                <div class="col-xs-12" style="margin-bottom:5px;">
                                                                    ...
                                                                    <input type="text" name="codeversion[]" value="<?php echo $val['code'] ?>" placeholder="" class="form-control code_color">
                                                                </div>
                                                                <div class="tab-content">
                                                                            ...
                                                                            <div class="box-body" style="padding:0px;">
                                                                                <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                                                    <div class="col-md-12" style="margin-top:5px;">
                                                                                        ...
                                                                                        <input type="text" name="titleversion[]" value="<?php echo $val['title'] ?>" class="form-control title" />
                                                                                        <span class="help-block hidden">Bạn cần nhập trường này</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="col-xs-12" style="margin-bottom:5px;">
                                                                    ...
                                                                    <input type="text" name="priceversion[]" value="<?php echo $val['price'] ?>" placeholder="" class="form-control price_color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
